...
const translations = {
    ka: {
        ...
        faq_typing: "იწერს...",
        faq_fallback: "ამ კითხვაზე ზუსტი პასუხი არ მაქვს, მაგრამ დამირეკეთ +995 555 00 00 00-ზე ან დაიწყეთ შეკვეთა \"კალათა\" ღილაკით — იქ AI კონსულტანტი დაგეხმარებათ დეტალურად.",
        ...
        faq_ans_contact: "დაგვირეკეთ: +995 555 00 00 00, მისამართი: ახალციხე, იაძის ქუჩა #2ი.",
    ...
    en: {
        ...
        faq_typing: "Typing...",
        faq_fallback: "I don't have an exact answer for that, but you can call +995 555 00 00 00 or start an order via the cart button, where our AI assistant can help with the details.",
        ...
        faq_ans_contact: "Call us: +995 555 00 00 00, address: 2i Iadze St, Akhaltsikhe.",
    ...
    ru: {
        ...
        faq_typing: "Печатает...",
        faq_fallback: "У меня нет точного ответа на этот вопрос, но вы можете позвонить по номеру +995 555 00 00 00 или начать оформление заказа через корзину — там AI консультант поможет с деталями.",
        ...
        faq_ans_contact: "Звоните: +995 555 00 00 00, адрес: Ахалцихе, ул. Иадзе №2и.",
    ...
    hy: {
        ...
        faq_typing: "Գրում է...",
        faq_fallback: "Այս հարցին ճշգրիտ պատասխան չունեմ, բայց կարող եք զանգահարել +995 555 00 00 00 կամ սկսել պատվեր «Զամբյուղ» կոճակով, որտեղ AI խորհրդատուն մանրամասն կօգնի:",
        ...
        faq_ans_contact: "Զանգահարեք՝ +995 555 00 00 00, հասցե՝ Ախալցխա, Իաձեի փող. #2ի:",
